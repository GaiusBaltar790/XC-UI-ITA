...
function checkTable($rTable) {
    ...
    $rTableQuery = Array(
        ...
        "languages" => Array("CREATE TABLE `languages` (`key` varchar(128) NOT NULL DEFAULT '', `language` varchar(4096) NOT NULL DEFAULT '', PRIMARY KEY (`key`)) ENGINE=InnoDB DEFAULT CHARSET=latin1;", "INSERT INTO `languages`(`key`, `language`) VALUES('en', 'English'),('it', 'Italiano'),('de', 'Deutsch'),('es', 'Espanol'),('ru', 'русский');"),
